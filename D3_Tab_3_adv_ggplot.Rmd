...
```{r plot8b, fig.height = 4, fig.width = 7, fold.plot = F}
...
```{r plot9la, fig.height = 4, fig.width = 7, fold.plot = F}
...
```{r plot9l, fig.height = 4, fig.width = 7, fold.plot = F}
p_site4 <- p_site3 + 
...
```{r plot11b, fig.height = 4, fig.width = 7, fold.plot = F}
ggplot(lakes_temp, aes(x = date, y = Value, color = SiteCode, 
                       fill = SiteCode, shape = SiteCode)) + 
  theme_bw() +
...
<p class = 'code'>Use Set2 palette on temperature plot</p>
...
```{r virmag, eval = F}
# magma
scales::show_col(magma(12), cex_label = 0.45, ncol = 6)
```
<center><img src = "./images/viridis/magma.png" alt = 'magma palette' style = "width:350px;"></center>
<br>
```{r virinf, eval = F}
# inferno
scales::show_col(inferno(12), cex_label = 0.45, ncol = 6)
```
<center><img src = "./images/viridis/inferno.png" alt = 'inferno palette' style = "width:350px;"></center>
<br>
```{r virpla, eval = F}
# plasma
scales::show_col(plasma(12), cex_label = 0.45, ncol = 6)
```
<center><img src = "./images/viridis/plasma.png" alt = 'plasma palette' style = "width:350px;"></center>
<br>
```{r virciv, eval = F}
# cividis
scales::show_col(cividis(12), cex_label = 0.45, ncol = 6)
```
<center><img src = "./images/viridis/cvidis.png" alt = 'cividis palette' style = "width:350px;"></center>
<br>
```{r virroc, eval = F}
# rocket
scales::show_col(rocket(12), cex_label = 0.45, ncol = 6)
```
<center><img src = "./images/viridis/rocket.png" alt = 'rocket palette' style = "width:350px;"></center>
<br>
```{r virmak, eval = F}
# mako
scales::show_col(mako(12), cex_label = 0.45, ncol = 6)
```
<center><img src = "./images/viridis/mako.png" alt = 'mako palette' style = "width:350px;"></center>
<br>
```{r virtur, eval = F}
# turbo
scales::show_col(turbo(12), cex_label = 0.45, ncol = 6)
```
<center><img src = "./images/viridis/turbo.png" alt = 'turbo palette' style = "width:350px;"></center>
<br>
...
p_pal + scale_color_viridis_d(name = "Lake", aesthetics = c("fill", "color"), 
                              option = 'turbo') + 
        guides(fill = guide_legend(override.aes = list(alpha = 1))) 
```
</details>
...
p_heat + 
  scale_color_viridis_c(name = "Temp. (F)", aesthetics = c("fill", "color")) 
```
...
p_heat +  scale_color_gradient(low = "#FBFFAD", high = "#AB1F1F", 
...
p_heat +  scale_color_gradient2(low = "navy", mid = "#FBFFAD", high = "#F54927", 
                                aesthetics = c("fill", 'color'),
