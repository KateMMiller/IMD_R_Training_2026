...
<center><h2>NPS IMD Intro to R Training: March 24 - 26, 2026</h2></center> {.tabset .tabset-pills}
--------------------------------------------------
...
```{r D3_wrang2, child = "D3_Tab_2_dates_NAs.Rmd", eval = T}
```

```{r D3_ggplot, child = "D3_Tab_3_adv_ggplot.Rmd", eval = T}
```

```{r D3_bp, child = "D3_Tab_4_coding_best_practices.Rmd", eval = T}
```
