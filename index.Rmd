...
```{r help, child = "D1_Tab_9_Getting_Help.Rmd", eval = T}
```

```{r keyshorts, child = "D1_Tab_10_Keyboard_Shortcuts.Rmd", eval = T}
```

```{r chall_d1, child = "D1_Tab_11_Challenges.Rmd", eval = T}
```
