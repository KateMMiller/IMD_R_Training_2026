...
```{r D1_goals, child = "D1_Tab_0_Goals.Rmd"}
```
...
```{r start_coding, child = "D1_Tab_4_Start_Coding.Rmd"}
```

```{r read_write, child = "D1_Tab_5_Read_Write_Data.Rmd"}
```

```{r datastr, child = "D1_Tab_6_Data_structures.Rmd"}
```

```{r basplot, child = "D1_Tab_7_Data_Exploration_and_Basic_Plotting.Rmd"}
```

```{r help, child = "D1_Tab_8_Getting_Help.Rmd"}
```

```{r keyshorts, child = "D1_Tab_9_Keyboard_Shortcuts.Rmd"}
```
