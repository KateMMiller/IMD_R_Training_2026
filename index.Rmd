...
```{r read_write, child = "D1_Tab_6_Data_structures_and_exploration.Rmd"}
```


```{r read_write, child = "D1_Tab_7_Getting_Help.Rmd"}
```

- Basic plotting

```{r read_write, child = "D1_Tab_9_Keyboard_Shortcuts.Rmd"}
```
