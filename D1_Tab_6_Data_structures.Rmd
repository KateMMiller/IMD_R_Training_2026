...
<strong>Question: How would you look at the the first 4 even rows (2, 4, 6, 8), and first 2 columns of the `ACAD_wetland` data frame?</strong>
...
<div class="alert alert-info">
<strong>Question: How many unique species are there in the `ACAD_wetland` data frame?</strong>
...
<div class="alert alert-info">
<strong>Question: Which sites have species that are considered protected on them (Protected = TRUE)?</strong>
