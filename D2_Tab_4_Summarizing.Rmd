...
<strong>Question: Using the ACAD_wetland data, calculate the average percent cover of native vs. invasive species per plot. Note that Invasive = TRUE is invasive and FALSE is native. </strong>
...
<div class="alert alert-info">
<strong>Question: Using the ACAD_wetland data, count the number of native vs. invasive species per plot. Note that Invasive = TRUE is invasive and FALSE is native. </strong>
<details><summary class='code2'>Answer</summary>
```{r wetinvr}
# Using group_by()
...
<div class="alert alert-info">
<strong>Question: Using ACAD_wetland data, calculate relative % cover of species within each site. This one is challenging!</strong>
<details><summary class='code2'>Answer</summary>
