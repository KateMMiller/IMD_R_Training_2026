...
<br>
<h3 style="color:red;">Data are useful only when used. Data are used only when understood.</h3>
...
<center>![](images/covid_by_region.png)</center>
...
```{r acme_heatmap, echo = FALSE, fig.width = 9, fig.align="center", message = FALSE, warning = FALSE, fold.plot = F, fold.output = F}
